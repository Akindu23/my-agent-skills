...
| [wayfinder](./skills/wayfinder/)                                         | `wayfinder`                     | Chart oversized work as a shared decision-ticket map on the issue tracker; resolve one frontier ticket per session until the way is clear.                                         |
