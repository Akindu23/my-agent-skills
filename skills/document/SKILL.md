...
5. **Use examples sparingly**. Prefer runnable commands, realistic config, and checked snippets. **Done when**: every example in the change is a runnable command, realistic config, or checked snippet (or there are none).
