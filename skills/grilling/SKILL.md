...
For Task `model` / `subagent_type` routing, follow [cursor-task-workflow.md](../council/references/cursor-task-workflow.md) (enum probe, Composer lane for parallel explore/survey workers). Do not copy routing tables into this skill.
