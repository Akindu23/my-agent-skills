---
name: tdd
description: TDD. Use when building or fixing test-first, or when the user mentions red-green-refactor.
---
...
Examples: [tests.md](tests.md). Mocking: [mocking.md](mocking.md).
