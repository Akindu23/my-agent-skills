...
When a mechanical change's blast radius fans across the whole codebase so no vertical slice can land green, sequence it as expand-contract per [references/wide-refactor.md](references/wide-refactor.md).
