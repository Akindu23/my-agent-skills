...
description: Writing for agents. Use when creating or editing skills, modifying AGENTS.md or CLAUDE.md, or tightening agent-facing docs (pointers, Done when, disclosure).
---
